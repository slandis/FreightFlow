...
describe("core scores and economy", () => {
  ...
  it("condition and morale decline when inventory support is both understaffed and underfunded", () => {
    ...
    runner.getState().contracts.activeContracts.push({
      ...
      freightClassId: "standard",
      inboundIntervalMinTicks: 75,
      inboundIntervalMaxTicks: 135,
      outboundIntervalMinTicks: 160,
      outboundIntervalMaxTicks: 260,
      nextInboundEligibleTick: 90,
      nextOutboundEligibleTick: 220,
